    ...
    internal class Program
    {
        ...
        static void Query3(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(e => e.Home_team == "France"
                                                             && e.Date.Year == 2021
                                                             && e.Country == "France"
                                                             && (e.Home_score == e.Away_score)).ToList();
            // Перевірка
            Console.WriteLine("\n======================== QUERY 3 ========================");
        ...
        static void Query4(List<FootballGame> games)
        {
            ...
            var selectedGames = games
                .Where(e => e.Date.Year >= 2018 && e.Date.Year <= 2020
                            && e.Away_team == "Germany"
                            && e.Away_score < e.Home_score).ToList();
        ...
        static void Query8(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(e => e.Tournament == "UEFA Euro" && e.Country == "Ukraine")
                            .Select(e => new
                            {
        ...
        static void Query9(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(e => e.Tournament == "UEFA Nations League" && e.Date.Year == 2023)
                 .Select(e => new
                 {
                     MatchYear = e.Date.Year,
